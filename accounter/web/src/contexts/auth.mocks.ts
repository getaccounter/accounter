import { LOGIN_MUTATION, LoginParameters, LoginResponse, SessionInfoQueryResponse, SESSION_INFO_QUERY } from './auth';
...
export const loginMutationRequestMock = Factory.Sync.makeFactory<MockedResponse['request']>({
...
export const getLoginFailureRequestMocks = (email: string, password: string, errorMessage: string) => [
  sessionInfoQuerySignedOutMock.build(),
